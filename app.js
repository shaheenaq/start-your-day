...
// let country;
// let locData;
// const urlLocate = "https://geoip-db.com/json/";

// fetch(urlLocate).then(response => {
...
// 		para1.innerHTML = `Today's weather in ${city},${country}`;
// 		document.getElementById('weather').appendChild(para1);

// 		let weatherData;
// 		const urlW = `http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&units=imperial&appid=e609adc51cd1d7c976b4c68b8e4e1962`;
// 		fetch(urlW)
